...
${OBJECTDIR}/SaBLExAPI_IncomingMsg_Common.o: SaBLExAPI_IncomingMsg_Common.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SaBLExAPI_IncomingMsg_Common.o SaBLExAPI_IncomingMsg_Common.c

${OBJECTDIR}/SaBLExAPI_IncomingMsg_Peripheral.o: SaBLExAPI_IncomingMsg_Peripheral.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SaBLExAPI_IncomingMsg_Peripheral.o SaBLExAPI_IncomingMsg_Peripheral.c

${OBJECTDIR}/SaBLExAPI_OutgoingMsg_Common.o: SaBLExAPI_OutgoingMsg_Common.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SaBLExAPI_OutgoingMsg_Common.o SaBLExAPI_OutgoingMsg_Common.c

${OBJECTDIR}/SaBLExAPI_OutgoingMsg_Peripheral.o: SaBLExAPI_OutgoingMsg_Peripheral.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SaBLExAPI_OutgoingMsg_Peripheral.o SaBLExAPI_OutgoingMsg_Peripheral.c
...
${OBJECTDIR}/json.o: json.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/json.o json.c
...
${OBJECTDIR}/rs232.o: rs232.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rs232.o rs232.c
